...
figures in "raw\_detected\_boxes", as well the output of figures which could be either "raw\_pdffigures\_output" or under Figures. Each figure type containing figure type which is either Table or Figure. Name, 
caption boundary, image text or caption text, page location, uri, page, and dpi. The metadata was extracted 
in the orginal work using PDFFigures2 and DeepFigures \cite{ACL}.
